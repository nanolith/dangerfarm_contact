...
//TAB is allowed ** STRING_FILTER_TEST(0x09);
//CR is allowed ** STRING_FILTER_TEST(0x0A);
...
STRING_FILTER_HIGH_TEST(x99, "\u0099");
STRING_FILTER_HIGH_TEST(x9A, "\u009A");
STRING_FILTER_HIGH_TEST(x9B, "\u009B");
STRING_FILTER_HIGH_TEST(x9C, "\u009C");
STRING_FILTER_HIGH_TEST(x9D, "\u009D");
STRING_FILTER_HIGH_TEST(x9E, "\u009E");
STRING_FILTER_HIGH_TEST(x9F, "\u009F");
...
VALID_SEQUENCE_TEST(cr, "\n");
VALID_SEQUENCE_TEST(tab, "\t");
