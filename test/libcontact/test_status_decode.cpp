...
TEST(decode_strings)
{
    ...
    MATCH_AND_ADD(ERROR_CONTACTFORM_SOCKETPAIR, 0);
    MATCH_AND_ADD(ERROR_CONTACTFORM_FORK, 1);
    MATCH_AND_ADD(ERROR_CONTACTFORM_SOCKET, 2);
    MATCH_AND_ADD(ERROR_CONTACTFORM_CONNECT, 1);
    MATCH_AND_ADD(ERROR_CONTACTFORM_DBSOCK_CLOSE, 0);
    MATCH_AND_ADD(ERROR_CONTACTFORM_DBPID_KILL, 0);
    MATCH_AND_ADD(ERROR_CONTACTFORM_DBPID_WAIT, 0);
}
