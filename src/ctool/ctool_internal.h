 ...
 */
int FN_DECL_MUST_CHECK
ctool_run_command(ctool_context* ctx);
 ...
 */
int FN_DECL_MUST_CHECK
ctool_run_get_count_command(ctool_context* ctx);
 ...
 */
int FN_DECL_MUST_CHECK
ctool_run_list_command(ctool_context* ctx);
 ...
 */
int FN_DECL_MUST_CHECK
ctool_run_get_command(ctool_context* ctx);
