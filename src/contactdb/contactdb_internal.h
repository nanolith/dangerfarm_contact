...
/* postconditions. */
MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    contactdb_disable_signal_handler, int retval)
MODEL_CONTRACT_POSTCONDITIONS_END(contactdb_disable_signal_handler)
...
/* postconditions. */
MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    contactdb_decode_and_dispatch, int retval)
MODEL_CONTRACT_POSTCONDITIONS_END(contactdb_decode_and_dispatch)
...
MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    contactdb_dnd_contact_form_append, contactdb_context* ctx, int sock)
        ...
        /* the socket is valid. */
        MODEL_ASSERT(prop_is_open_fd(sock));
MODEL_CONTRACT_PRECONDITIONS_END(contactdb_dnd_contact_form_append)

/* postconditions. */
MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    contactdb_dnd_contact_form_append, int retval)
MODEL_CONTRACT_POSTCONDITIONS_END(contactdb_dnd_contact_form_append)
...
MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    contactdb_dnd_contact_form_get_count, contactdb_context* ctx, int sock)
        ...
        /* the socket is valid. */
        MODEL_ASSERT(prop_is_open_fd(sock));
MODEL_CONTRACT_PRECONDITIONS_END(contactdb_dnd_contact_form_get_count)

/* postconditions. */
MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    contactdb_dnd_contact_form_get_count, int retval)
MODEL_CONTRACT_POSTCONDITIONS_END(contactdb_dnd_contact_form_get_count)
...
MODEL_CONTRACT_PRECONDITIONS_BEGIN(
    contactdb_dnd_contact_form_get, contactdb_context* ctx, int sock)
        ...
        /* the socket is valid. */
        MODEL_ASSERT(prop_is_open_fd(sock));
MODEL_CONTRACT_PRECONDITIONS_END(contactdb_dnd_contact_form_get)

/* postconditions. */
MODEL_CONTRACT_POSTCONDITIONS_BEGIN(
    contactdb_dnd_contact_form_get, int retval)
MODEL_CONTRACT_POSTCONDITIONS_END(contactdb_dnd_contact_form_get)
