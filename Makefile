...
ALL: CHECKED_TARGETS RELEASE_TARGETS
	echo LIBCONTACT_SOURCES=$(LIBCONTACT_SOURCES)
	echo LIBCONTACT_STRIPPED_SOURCES=$(LIBCONTACT_STRIPPED_SOURCES)
	echo LIBCONTACT_DIRS=$(LIBCONTACT_DIRS)
	echo LIBCONTACT_CHECKED_DIRS=$(LIBCONTACT_CHECKED_DIRS)
	echo LIBCONTACT_CHECKED_OBJECTS=$(LIBCONTACT_CHECKED_OBJECTS)
	echo LIBCONTACT_RELEASE_DIRS=$(LIBCONTACT_RELEASE_DIRS)
	echo LIBCONTACT_RELEASE_OBJECTS=$(LIBCONTACT_RELEASE_OBJECTS)
