...
RELEASE_TARGETS: $(CTOOL_RELEASE_DIRS)
RELEASE_TARGETS: $(LIBCONTACT.RELEASE) $(CONTACTDB) $(CTOOL)

$(CHECKED_BUILD_DIR) $(RELEASE_BUILD_DIR) $(TEST_DIRS) $(CONTACTDB_RELEASE_DIRS) $(CTOOL_RELEASE_DIRS):
	mkdir -p $@
